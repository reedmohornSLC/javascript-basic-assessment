...
var iLove = 'I love';
var iLoveCode = iLove + " code"; ///question wasnt clear to me
...
function removeItem(arrayOfStrings, string){
	for(i=0;i<arrayOfStrings.length;i++){
		if(arrayOfStrings[i]== string){
			arrayOfStrings.splice(string,1);
...
// the current time as a Date object////WHAT???
...
function outside (temperature, humidity, cloudiness){
	...
	}else if (temperature>80 && cloudiness<20 && humidity<40) {
